...
export function getConfig(): VisCalcConfig {
    return {
        ivs: [
            ...
            { name: 'Methylene blue', label: 'Methylene blue (ug/kg/min)', term: multDoseCalculation(NonNegativeNumber.get(20)) },
            ...
            { name: 'Terlipressin', label: 'Terlipressin (ug/kg/min)', term: multDoseCalculation(NonNegativeNumber.get(10)) },
            { name: 'Angiotensin II', label: 'Angiotensin II (ug/kg/min)', term: multDoseCalculation(NonNegativeNumber.get(0.25)) },
